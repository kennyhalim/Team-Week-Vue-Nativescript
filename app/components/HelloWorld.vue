            ...
            <StackLayout row="0">
                ...
                <GridLayout class="weather-box" columns="1*,1*" rows="auto">
                    ...
                    <StackLayout col="1" row="0">
                        ...
                        <Label class="small" :text="long"></Label>
                        <Label class="small" :text="lat"></Label>
                    </StackLayout>
                </GridLayout>
            ...
            getMyWeather() {
                ...
                Geolocation.getCurrentLocation({
                    ...
                    loc => {
                        if (loc) {
                            var appId =
                                "4bf97b659837b67adc16ed0a6993713e";
                            var url =
                                ...
                                "&lon=" +
                                loc.longitude;
                            this.long = "longitude: " + loc.longitude;
                            this.lat = "latitude: " + loc.latitude;
                            http.request({
                                url: url,
                                method: "GET"
